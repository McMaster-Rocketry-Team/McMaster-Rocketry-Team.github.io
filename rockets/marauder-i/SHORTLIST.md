...
- Shipped as `public/media/rockets/marauder-i.png`, 252x1641 RGBA, renders **68x440**.
...
- Reproduce (BiRefNet mask already at `/tmp/mrt-cutout/m1b-bire-rot.png` if you
  don't want to re-run `mask`):
      ...
      $V scripts/cut-fleet-cutout.py finish m1-rot.png m1-cut.png \
          --keep 520,168,250,1660 \
          --erase 520,700,73,90 \
          --erase 520,1388,70,50 \
